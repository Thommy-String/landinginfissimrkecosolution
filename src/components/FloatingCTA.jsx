    ...
    <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50 px-4 w-full max-w-sm">
      ...
      >
        ...
        <a
          ...
          onClick={(e) => {
            ...
            if (typeof gtag_report_conversion === 'function') {
              gtag_report_conversion(whatsappLinkWithMessage);
            } else {
        ...
        >
          ...
          <span className="text-sm font-semibold text-white tracking-tight">Messaggio</span>
        </a>
        ...
        <a
          ...
          onClick={() => typeof gtag_report_conversion === 'function' && gtag_report_conversion(azienda.telefonoLink)}
      ...
      {/* Caption */}
      <p className="text-center text-[11px] text-gray-400 font-medium tracking-wide pb-0.5">
