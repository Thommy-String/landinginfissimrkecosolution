  ...
  return (
    <section className="relative flex items-center justify-center overflow-hidden py-2 sm:py-16">
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-8 sm:py-12 text-center">
        ...
        {/* Headline principale */}
        <h1 className="text-xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-[-0.065em] text-gray-900 leading-[1.3] mb-7">
        ...
        {/* Check list */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-8 mx-auto mb-10">
          {[
            ...
            <div key={i} className="flex items-center gap-2">
              ...
              <span className="text-base sm:text-lg font-semibold text-gray-600">{item}</span>
            </div>
          ))}
        </div>
      </div>
