import taglioVideo from '../assets/videos/taglioLamaProfiloMRK.mp4'

export default function QualityVideoBanner() {
  return (
    <section className="bg-white pt-32 px-6 py-8">
        ...
        <div className="relative rounded-2xl overflow-hidden shadow-lg" style={{ height: '300px' }}>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-8">
              {[
                'Profili Tedeschi certificati VEKA',
                'Garanzia 10 anni',
              ].map((item, i) => (
